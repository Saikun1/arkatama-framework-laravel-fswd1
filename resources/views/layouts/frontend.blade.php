            ...
            <div class="footer-top-area pt-70 pb-35 wrapper-padding-5">
                <div class="container-fluid">
                    <div class="widget-wrapper">
                        ...
                        <div class="footer-widget mb-30">
                            <h3 class="footer-widget-title-5">Informasi Contact</h3>
                            <div class="footer-info-wrapper-3">
                                <div class="footer-address-furniture">
                                    ...
                                    <div class="footer-info-content3">
                                        <p>Jl. Pasundan No.108, Kec Regol, Kel Pungkur <br>Kota Bandung</p>
                                    </div>
                                </div>
                                <div class="footer-address-furniture">
                                    <div class="footer-info-icon3">
                                ...
                                <div class="footer-address-furniture">
                                    ...
                                    <div class="footer-info-content3">
                                        <p><a href="#"> nelyan@gmail.com</a> <br><a href="#"> nelayan@gmail.info</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="footer-widget mb-30">
                            ...
                            <div class="footer-newsletter-2">
                                <p>Kirimi kami email Anda atau pembaruan berikutnya</p>
                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            <div class="copyright-furniture">
                                <p>Copyright © <a href="https://hastech.company/">Nelayan</a> 2023 . All Right Reserved.</p>
                            </div>
                        </div>
                    </div>
                </div>
